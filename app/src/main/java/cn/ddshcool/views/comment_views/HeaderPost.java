...
import cn.ddshcool.services.adapters.StatusGridImgsAdapter;
import cn.ddshcool.utils.StringUtils;
import cn.ddshcool.utils.TimeUtil;

/**
 * 用于显示头部
 * TODO 点赞逻辑没有处理 等级显示逻辑没有处理 评论按钮逻辑没有处理 性别显示没有处理 ...
 * Created by yosemite on 15/9/10.
 */
public class HeaderPost {

    private static View convertView;   //缓存视图
    ...
    public HeaderPost(Context context,Post post){
    ...
    public View getHeaderPost(View.OnClickListener onCommentListener){
...
//		});
        //评论按钮监听
        holder.ll_comment_bottom.setOnClickListener(onCommentListener);
